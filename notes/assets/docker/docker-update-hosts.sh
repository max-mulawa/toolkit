...
# source: https://github.com/rs-renato/scripts/blob/master/docker-update-hosts.sh
# article: https://www.linkedin.com/pulse/learn-how-access-docker-container-its-name-from-host-renato-rodrigues/
# usage: sudo ./docker-update-hosts.sh --address 127.0.0.1 --hosts /etc/hosts --verbose
